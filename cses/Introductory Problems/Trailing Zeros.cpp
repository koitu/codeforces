...
int main() {
    ...
    // looked at solution :(
    // main idea: when we find the prime factors of all the numbers we want to count min(# of 2s, # of 5s)
    // - we know that thare will always be much more prime factors that are 2 than 5
    // - since only 1/5 of the numbers are divisable by 5 we divide by 5
    //  - then 1/25 of the numbers are twice divissable by 5 so divide by 25
    //  - ...
